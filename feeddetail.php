...
.style11 {font-size: xx-large; font-weight: bold; text-align:center; color:#FFFFFF;text-decoration:none;}
...
<br /><br /> <center> <span class="style11">ONLINE PORTAL FOR THE INTEGRATED<br /> AGRICULTURAL SYSTEM</span><span class="style12"></span> &nbsp;</td>
   ...
   <td><center>
	...
	<td><div align="center" class="style13"><a href="productdetail.php" class="style10">PRODUCT DETAILS</a></div></td>
		...
		<td><div align="center" class="style13"><a href="farmerdetail.php" class="style10">SELLER  DETAILS</a></div></td>
...
<center>
      ...
      <p align="center" class="style8 style9 style15"><strong>FEEDBACK DETAILS </strong></p>
     
	  <table width="90%" height="150" border="1" align="center" cellpadding="5px" cellspacing="0">
  <tr bgcolor="#333333">
    <td width="83" bgcolor="#66CC66"><strong>Date</strong></td>
    <td width="94" bgcolor="#66CC66"><strong>Name</strong></td>
	<td width="58" bgcolor="#66CC66"><strong>Phone</strong></td>
    <td width="57" bgcolor="#66CC66"><strong>Feedback</strong></td>
...
mysql_select_db("onlineagri") or die("Database Error"); 
  ...
  $sel=mysql_query("select * from tb_feed") or die("Table Error");
						while($row=mysql_fetch_array($sel))
						{
						$img=$row['img']
						?>
  <tr bgcolor="#FFFFFF">
    <td><span class="style22"><?php echo $row['edate'];?></span></td>
    <td><span class="style22"><?php echo $row['uname'];?></span></td>
	<td><span class="style22"><?php echo $row['phone'];?></span></td>
    <td><span class="style22"><?php echo $row['feed'];?></span></td>
