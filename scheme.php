...
mysql_select_db("onlineagri") or die("Database Error"); 
 $qry="SELECT id FROM scheme ORDER BY id DESC";
  $set=mysql_query($qry);
...
<br /><br /> <center> <span class="style11">ONLINE PORTAL FOR THE INTEGRATED<br /> AGRICULTURAL SYSTEM</span><span class="style12"></span> &nbsp;</td>
  ...
  <tr><td height="221" valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="schemedata.php" enctype="multipart/form-data">
<p align="right"> 
<a href="aschema.php" style="background:#FFFF00; text-decoration:none; padding:15PX">VIEW SCHEME</a>
<a href="aaschema.php" style="background:#FFFF00; text-decoration:none; padding:15PX">APPLY SCHEME</a></p>
<table width="400" height="348" border="0" align="center">
      <tr>
        <td height="56" colspan="2"><div align="center" class="style15"><span class="style19 style8 style20"><strong>SCHEME DETAILS</strong></span></div></td>
        </tr>
      <tr>
        <td><span class="style8 style19"><strong>SCHEME  ID </strong></span></td>
        <td> 
          <input name="id" type="text" id="id" value="<?php echo $id;?>" required/>          </td>
      </tr>
      <tr>
        <td><span class="style8 style19"><strong>SCHEME NAME</strong></span></td>
        <td> 
          <input name="proname" type="text" id="proname" required/>           </td>
      </tr>
	   <tr>
        <td><span class="style8 style19"><strong>LOAN AMOUNT</strong></span></td>
        <td> 
          <input name="qty" type="text" id="qty"  required/>           </td>
      </tr>
