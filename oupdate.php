...
$q="insert into tb_order values('$proid','$proname','$price','$protype','$oname','$oaddress','$oph','pending','$fname','$qty','$odate','$tot','','$r1','$bank','$acno','$cvv')";
 $status=mysql_query($q);

$q1="update product set qty=qty-$qty where id='$proid'";

$status1=mysql_query($q1);
