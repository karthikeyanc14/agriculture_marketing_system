...
<center>
      ...
      <p align="center" style="color:#006666"><strong>SCHEME DETAILS </strong></p>
  ...
  <tr bgcolor="#333333">
    ...
    <td width="57" bgcolor="#66CC66"><strong>MORE DETAILS</strong></td>
	 <td width="57" bgcolor="#66CC66"><strong>FARMER NAME</strong></td>
	  <td width="57" bgcolor="#66CC66"><strong>ADDRESS</strong></td>
	   <td width="57" bgcolor="#66CC66"><strong>PHONE</strong></td>
...
mysql_select_db("onlineagri") or die("Database Error"); 
  ...
  $sel=mysql_query("select * from apply") or die("Table Error");
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><span class="style22"><?php echo $row['sname'];?></span></td>
    ...
    <td><span class="style22"><?php echo $row['edesc'];?></span></td>
	 <td><span class="style22"><?php echo $row['uname'];?></span></td>
	  <td><span class="style22"><?php echo $row['address'];?></span></td>
	   <td><span class="style22"><?php echo $row['phine'];?></span></td>
